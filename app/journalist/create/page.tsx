    ...
    <>
      ...
      <div className="p-6 flex-1">
        <div className="grid lg:grid-cols-[1fr_280px] gap-5 items-start">
          ...
          {/* ── Editor ── */}
          <div className="bg-white/90 backdrop-blur-sm border border-[#e8f5ea] rounded-2xl shadow-sm p-6">
            <div className="flex items-center gap-2 mb-5">
              <span className="w-1 h-5 rounded-full bg-[#1a5c2a]" />
              <h2 className="text-lg font-extrabold text-[#1a5c2a]">✏️ Create New Article</h2>
            </div>
            ...
            <input
              ...
              className="w-full text-xl font-bold text-gray-900 placeholder-gray-300 border-b-2 border-[#e8f5ea] focus:border-[#4caf28] outline-none pb-2 mb-5 bg-transparent transition-colors"
            />
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-5">
              <div>
                ...
                <select
                  ...
                  className="w-full border border-[#e8f5ea] rounded-xl px-3 py-2 text-sm text-gray-800 outline-none focus:border-[#4caf28] focus:ring-2 focus:ring-[#4caf28]/20 bg-white transition-all duration-300"
                >
                ...
                {MONETIZE_OPTIONS.map(opt => (
                  <label
                    ...
                    className={`flex items-center gap-3 p-3 rounded-xl border-2 cursor-pointer transition-all duration-300 ${
                      monetization === opt.value ? 'border-[#1a5c2a] bg-[#f0faf2]' : 'border-[#e8f5ea] hover:border-[#4caf28]/50'
                    }`}
                  >
                    <input
                      type="radio"
            ...
            {/* Action buttons */}
            <div className="flex items-center justify-between pt-4 border-t border-[#e8f5ea]">
              <button
          ...
          <div className="space-y-4">
              ...
              {imagePreview ? (
                <div className="relative w-full aspect-video rounded-xl overflow-hidden mb-3">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 bg-[#c8102e] hover:bg-[#a30d25] text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold transition-all duration-300"
            ...
            {/* Status */}
            <div className="bg-white/90 backdrop-blur-sm border border-[#e8f5ea] rounded-2xl shadow-sm p-4 transition-all duration-300 hover:shadow-md">
              <h4 className="text-sm font-bold text-[#1a5c2a] mb-3">📋 Article Status</h4>
              <div className="bg-[#f0faf2] border border-[#e8f5ea] rounded-xl px-3 py-2 text-sm text-[#1a5c2a] flex items-center gap-2">
            ...
            {/* Checklist */}
            <div className="bg-white/90 backdrop-blur-sm border border-[#e8f5ea] rounded-2xl shadow-sm p-4 transition-all duration-300 hover:shadow-md">
              <h4 className="text-sm font-bold text-[#1a5c2a] mb-3">✅ Checklist</h4>
