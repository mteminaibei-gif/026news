      ...
      try {
        await sendEmail({
          ...
          html: `
            ...
            <p><a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://026news.vercel.app'}/journalist/profile" style="display:inline-block;margin-top:16px;padding:12px 24px;background:#0f766e;color:#fff;border-radius:8px;text-decoration:none;font-weight:600;">Go to your journalist dashboard</a></p>
